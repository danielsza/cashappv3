    ...
    public partial class MainForm : Form
    {
        ...
        private async Task OpenDrawerAsync()
        {
            ...
            if (docType == "BOD")
            {
                ...
                _inText.Text = bodForm.TotalFloat.ToString("0.00");  // BOD is money IN
                _outText.Text = "0.00";  // No money out for BOD
                
                // Store BOD float on server
                try
                {
            ...
            else if (docType == "EOD")
            {
                ...
                _inText.Text = "0.00";  // EOD is just a count verification
                _outText.Text = "0.00";
            }
