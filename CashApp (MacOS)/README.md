...
time.sleep(0.5)          # Hold for 500ms (default, configurable)
serial_port.dtr = False  # De-energize relay
```

**Relay Duration**: Configurable in `server_config.ini`:
- Default: 0.5 seconds (500ms)
- Range: 0.1 - 5.0 seconds typically
- Adjust based on your cash drawer model
